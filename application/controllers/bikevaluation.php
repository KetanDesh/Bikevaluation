...
class BikeValuation extends REST_Controller {
    ...
    function api_get(){
        ...
        if($web){
            if($on_rd_price){
                echo "<h3>On road price : <small> Rs.</small>$on_rd_price<h3>";
                echo "<h3>Depreciated on road price:<small> Rs.</small>$dataweb</h3>";
            }else{
            echo "<h3>Original price:<small> Rs.</small>$bike_price<h3>";
            echo "<h3>Depreciated on road price:<small> Rs.</small>$dataweb</h3>";
            }
        }else{
            echo $response;
