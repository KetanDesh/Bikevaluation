<div class="container-fluid"  id="container" style="margin-top:66px;">
    <div class="row">
        <div class="col-sm-2" style="background-color: black;height:560px;">
            <ul>
                <li><a  href="<?php echo base_url().'index.php/Pricematrix' ?>">Dealer Price Matrix</a></li>
                <li><a href="<?php echo base_url().'index.php/DataCollection' ?>">Dealer Pricing</a></li>
            </ul>
        </div>
